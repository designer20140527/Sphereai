        ...
        <div className="footer-main">
          ...
          <div className="footer-logo-section">
            <div className="footer-logo-container">
              ...
              <div className="footer-social-icons">
                <Link href="https://t.me/Sphere_ai_Portal" target="_blank" className="footer-icon-link">
                ...
                <Link href="https://x.com/Sphereai_" target="_blank" className="footer-icon-link">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="footer-social">
            ...
            <div className="footer-social-links">
              <Link href="https://t.me/Sphere_ai_Portal" target="_blank" className="footer-social-link">
                Telegram
              </Link>
              <Link href="https://x.com/Sphereai_" target="_blank" className="footer-social-link">
                Twitter
              </Link>
